<div class="container">
    <div class="row">
        <div class="col-12">
            <img class="quem-somos" src="<?= get_template_directory_uri() . '/assets/img/logo-branco.png'?>" width="170" alt="">
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12 col-md-4">
            <h4>Endereço</h4>
            <p>
                <img class="info" src="<?= get_template_directory_uri() . '/assets/img/ICONE_LOCAL.png'?>" alt="">
                Av. Paulista, 1842 - 15º andar<br />São Paulo - SP
            </p>
            <p>
                <img class="info" src="<?= get_template_directory_uri() . '/assets/img/ICONE_USER.png'?>" alt="">
                <a class="d-block" href="mailto:atendimento@abbc.org.br">atendimento@abbc.org.br</a>
                <a class="d-block" href="tel:+551132881688">Telefone: +55 (11) 3288-1688</a>
            </p>
        </div>
        <div class="col-12 col-md-4">
